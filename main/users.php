...
<div class="container mt-5 users-main-container">
  ...
  <header class="users-header d-flex justify-content-between align-items-center">
    ...
    <div class="role-guide">
      <span class="badge" style="background-color: rgba(1, 61, 83, 0.5); color: white;">Admin</span>
      <span class="badge" style="background-color:rgba(53, 94, 59, 0.5); color: white;">Cashier</span>
      <span class="badge" style="background-color:rgba(160, 81, 45, 0.5); color: white;">Staff</span>
    </div>
